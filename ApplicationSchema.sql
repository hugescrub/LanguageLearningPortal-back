...
CREATE TABLE `courses` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKpag0ngrmsyx23ii8bnu9k0438` (`title`),
...
CREATE TABLE `enrollment` (
  ...
  CONSTRAINT `FK4x08no2mpupkr616h50w3aksx` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FK7ofybdo2o0ngc4de3uvx4dxqv` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (1,'ROLE_USER'),(2,'ROLE_TEACHER'),(3,'ROLE_ADMIN');
...
CREATE TABLE `teachers` (
  ...
  KEY `FK8svn5po43ifls1umooh4yuefm` (`username`,`email`),
  CONSTRAINT `FK8svn5po43ifls1umooh4yuefm` FOREIGN KEY (`username`, `email`) REFERENCES `users` (`username`, `email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_fnranlqhubvw04boopn028e6` (`username`,`email`),
...
-- Dump completed on 2022-05-31 17:19:24
